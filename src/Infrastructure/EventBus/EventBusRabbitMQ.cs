...
namespace eInvoice.Hungary.Infrastructure.EventBus
{
    ...
    {
        const string BROKER_NAME = "einvoice_hungary_event_bus";

        private readonly IRabbitMQConnection _connection;
        private readonly ILogger<EventBusRabbitMQ> _logger;
        private readonly IEventBusSubscriptionManager _subsManager;
        private readonly ILifetimeScope _autofac;
        private readonly string AUTOFAC_SCOPE_NAME = "einvoice_hungary_event_bus";
        ...
        private IModel CreateConsumerChannel()
        {
            ...
            channel.ExchangeDeclare(BROKER_NAME, type: "direct");
